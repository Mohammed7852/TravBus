...
const getBookingorderByClientNamequery=`SELECT order_id,trip_id,client_name,client_phoneno,client_identity_image,
TO_CHAR(trip_date::Date,'dd/mm/yyyy') AS trip_date ,
TO_CHAR(trip_date::Date,'dd/mm/yyyy') AS booking_date,payment_type FROM booking_orders WHERE client_name = $1`;
